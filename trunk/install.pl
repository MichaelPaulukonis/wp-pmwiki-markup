#!/usr/bin/perl -w
# copy dev versions of code into working dirs
# replace holders in files as required
# ie, personal URLs, etc. are needed for working dir,
# but should be a placeholder in dev

# D:\projects\www\1and1\interference\wp-content\plugins
